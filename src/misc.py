...
class Colors:
    def __init__(self) -> None:
        ...
        self.entry_text_color = ctk.ThemeManager.theme["CTkEntry"]["text_color"]
        ...
        self.combobox_text_color_disabled = ctk.ThemeManager.theme["CTkComboBox"]["text_color_disabled"]
